...
import { USER_SUPER_ADMIN, USER_SCHOOL_ADMIN, USER_SCHOOL_SUB_ADMIN } from '../constants';
  ...
  return (
    <div className="app-sidebar sidebar-shadow">
      ...
      <div className="app-header__mobile-menu">
        <div>
          <Button onClick={() => {}} type="button" className="hamburger hamburger--elastic mobile-toggle-nav">
            <span className="hamburger-box">
              <span className="hamburger-inner" />
            </span>
          </Button>
        ...
        <div className="app-sidebar__inner">
          <ul className="vertical-nav-menu mt-4">
            ...
            {user?.user_type_id === USER_SCHOOL_ADMIN && (
              <li>
                <Link to="/sub-user" className={location.pathname === '/sub-user' ? 'mm-active' : ''} onClick={location.pathname === '/sub-user' ? onLinkClick : onDropDownHide}>
                  <i className="metismenu-icon pe-7s-display2" />
                  User Management
                </Link>
              </li>
            )}
            {(user?.user_type_id === USER_SCHOOL_ADMIN || user?.user_type_id === USER_SCHOOL_SUB_ADMIN) && (
              <>
                ...
                <li className={`has-dropdown ${activeDrawerMenu === 'grades-management' ? 'mm-active' : ''}`}>
                  ...
                  <ul className={`mm-collapse ${activeDrawerMenu === 'grades-management' ? 'mm-show' : ''}`}>
                    ...
                    <li>
                      <Link to="/classes-list" className={location.pathname === '/classes-list' ? 'mm-active' : ''} onClick={location.pathname === '/classes-list' ? onLinkClick : onDropDownHide}>
                        <i className="metismenu-icon" />
                        Students
                      </Link>
                    </li>
                    <li>
                      <Link to="/attendance-management" className={location.pathname === '/attendance-management' ? 'mm-active' : ''} onClick={location.pathname === '/attendance-management' ? onLinkClick : onDropDownHide}>
                        <i className="metismenu-icon" />
                        Attendance Management
                      </Link>
                    </li>
                    <li>
                      <Link to="/marks-management" className={location.pathname === '/marks-management' ? 'mm-active' : ''} onClick={location.pathname === '/marks-management' ? onLinkClick : onDropDownHide}>
                        <i className="metismenu-icon" />
                        Marks Management
                      </Link>
                    </li>
                ...
                <li className={`has-dropdown ${activeDrawerMenu === 'reporting' ? 'mm-active' : ''}`}>
                  ...
                  <ul className={`mm-collapse ${activeDrawerMenu === 'reporting' ? 'mm-show' : ''}`}>
                    <li>
                      <Link to="/finance-reports" className={location.pathname === '/finance-reports' ? 'mm-active' : ''} onClick={location.pathname === '/finance-reports' ? onLinkClick : onDropDownHide}>
                        <i className="metismenu-icon" />
                        Financial Reports
                      </Link>
                    </li>
                    <li>
                      <Link to="/daily-entries" className={location.pathname === '/daily-entries' ? 'mm-active' : ''} onClick={location.pathname === '/daily-entries' ? onLinkClick : onDropDownHide}>
                        <i className="metismenu-icon" />
                        Entries Daily  Reports
                      </Link>
                    </li>
                  </ul>
                </li>
                <li className={`has-dropdown ${activeDrawerMenu === 'tuition' ? 'mm-active' : ''}`}>
                  ...
                  <ul className={`mm-collapse ${activeDrawerMenu === 'tuition' ? 'mm-show' : ''}`}>
                    <li>
                      <Link to="/enrollments" className={getActive('/enrollments') ? 'mm-active' : ''} onClick={location.pathname === '/enrollments' ? onLinkClick : onDropDownHide}>
                        <i className="metismenu-icon" />
                        Enrollment
                      </Link>
                    </li>
