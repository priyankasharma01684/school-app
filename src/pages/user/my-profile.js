                  ...
                  <div className="menu-header-content">
                    <div className="avatar-icon-wrapper btn-hover-shine mb-2 avatar-icon-xxl">
                      <div className="avatar-icon rounded">
                        <img src={user.profile_picture ? encodeURI(user.profile_picture) : Utils.getImage('user-placeholder.png')} alt="Profile Pic" />
                      </div>
                    </div>
                    <div>
                      <h5 className="menu-header-title text-white">{user ? user.name.capitalizeEachLetter() : ''}</h5>
                      <Button
